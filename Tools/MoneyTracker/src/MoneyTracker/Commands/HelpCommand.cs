    ...
    public class HelpCommand : ICommand
    {
        ...
        public Task<bool> ExecuteAsync()
		{
			return Task.Run(() => {
            	...
            	helpTextBuilder.AppendLine("Usage:  MoneyTracker <command> [OPTION]  ");
            	helpTextBuilder.AppendLine("");
				helpTextBuilder.AppendLine("    add");
				helpTextBuilder.AppendLine("    check");
				helpTextBuilder.AppendLine("    init");
				helpTextBuilder.AppendLine("    backup");
				//helpTextBuilder.AppendLine("    merge");
				helpTextBuilder.AppendLine("");
