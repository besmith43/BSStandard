...
var projFile = "./src/BSmith.Blazor.Server";
...
Task("Build")
    ...
    .Does(() => {
        ...
        if (DirectoryExists("./src/testing.compilers/wwwroot/less"))
        {
            Information("Compiling Less");
            StartProcess("powershell.exe", new ProcessSettings{ Arguments = "-NoProfile -Command lessc ./src/testing.compilers/wwwroot/less/site.less ./src/testing.compilers/wwwroot/css/site.css"});
        }

        if (DirectoryExists("./src/testing.compilers/wwwroot/ts"))
        {
            Information("Compiling TypeScript");
            StartProcess("powershell.exe", new ProcessSettings{ Arguments = "-NoProfile -Command tsc --outFile ./src/testing.compilers/wwwroot/js/site.js -t ES5 ./src/testing.compilers/wwwroot/ts/site.ts"});
        }
