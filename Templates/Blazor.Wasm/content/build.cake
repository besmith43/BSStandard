...
var projFile = "./src/BSmith.Blazor.Wasm";
...
Task("Build")
    ...
    .Does(() => {
        if (DirectoryExists("./src/testing.compilers/wwwroot/less"))
        {
            ...
            StartProcess("powershell.exe", new ProcessSettings{ Arguments = "-NoProfile -Command lessc ./src/testing.compilers/wwwroot/less/app.less ./src/testing.compilers/wwwroot/css/app.css"});
        }

        if (DirectoryExists("./src/testing.compilers/wwwroot/ts"))
        {
            Information("Compiling TypeScript");
            StartProcess("powershell.exe", new ProcessSettings{ Arguments = "-NoProfile -Command tsc --outFile ./src/testing.compilers/wwwroot/js/app.js -t ES5 ./src/testing.compilers/wwwroot/ts/app.ts"});
        }
